class Level3 extends Level{
  ...
  Level3(){ // Argumentless constructor
    thisLevel = 3;
    gameMaxTimeSec = 4 * 60;
    ...
    // Assign ingredients
    interactiveObjects.add(new Storage(35, 150, 0.1, "Tomato"));
    interactiveObjects.add(new Storage(35, 250, 0.1, "Mushroom"));
    interactiveObjects.add(new Storage(35, 350, 0.1, "Potato"));
    
    interactiveObjects.add(new ChoppingBoard(985, 145));
    interactiveObjects.add(new ChoppingBoard(985, 255));
    
    interactiveObjects.add(new Pot(140, 865));
    interactiveObjects.add(new Pot(230, 865));
  ...
  void drawMainKitchen(){
    ...
    noTint();
    image(pot,103,838,75,55);
    image(pot,193,838,75,55);
