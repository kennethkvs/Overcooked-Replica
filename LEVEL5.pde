class Level5 extends Level{
  ...
  Level5(){ // Argumentless constructor
    thisLevel = 5;
    gameMaxTimeSec = 5 * 60;
    ...
    // Assign ingredients
    interactiveObjects.add(new Storage(35, 150, 0.2, "Dough"));
    interactiveObjects.add(new Storage(35, 250, 0.2, "Mushroom"));
    interactiveObjects.add(new Storage(35, 350, 0.2, "Salami"));
    interactiveObjects.add(new Storage(35, 450, 0.2, "Cheese"));
    interactiveObjects.add(new Storage(35, 550, 0.2, "Tomato"));
    ...
    interactiveObjects.add(new ServingTray(950, 450, new String[]{"canadianPizza", "cheesePizza", "mushroomPizza", "pepperoniPizza"}, 10000, this));
